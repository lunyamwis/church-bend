...
class MinistryType(DjangoObjectType):
    """
...
class MinistryInput(graphene.InputObjectType):
    """
...
class MinistryPaginatedType(graphene.ObjectType):
    """
    ...
    items = graphene.List(MinistryType)
